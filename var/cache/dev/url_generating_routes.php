...
return [
    ...
    'cgv' => [[], ['_controller' => 'App\\Controller\\HomeController::cgv'], [], [['text', '/conditions_generales_vente']], [], [], []],
    'mentions' => [[], ['_controller' => 'App\\Controller\\HomeController::mentions'], [], [['text', '/mentions_legales']], [], [], []],
    ...
    'products_categoryVAC' => [['category', 'categoryVAC'], ['_controller' => 'App\\Controller\\ProductController::productsCategoryVAC'], [], [['variable', '/', '[^/]++', 'categoryVAC', true], ['variable', '/', '[^/]++', 'category', true], ['text', '/product/list']], [], [], []],
