...
class __TwigTemplate_c0bcedcc3f7f013c2d18e78f2ba1463448bf0bce179666a62a9e32287b37c666 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"row\">
        ...
        // line 20
        echo twig_escape_filter($this->env, twig_number_format_filter($this->env, (twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 20, $this->source); })()), "price", [], "any", false, false, false, 20) / 100), 2, ",", "."), "html", null, true);
        echo " €</span>
            ...
            <a href=\"";
        // line 24
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("add-to-cart", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 24, $this->source); })()), "id", [], "any", false, false, false, 24)]), "html", null, true);
...
";
    ...
    {
        return array (  125 => 24,  118 => 20,  114 => 19,  110 => 18,  101 => 14,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "product/show.html.twig", "C:\\wamp64\\www\\RecupServerDosoprt4\\dosport\\templates\\product\\show.html.twig");
    }
}
