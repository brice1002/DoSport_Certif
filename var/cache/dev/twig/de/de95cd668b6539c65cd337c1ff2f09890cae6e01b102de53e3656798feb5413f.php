...
class __TwigTemplate_0458e0cf4d282d87eb2e5bae33d7da0b56d5f40a88de0c86c468aaaf4708ced8 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  146 => 40,  142 => 39,  137 => 38,  132 => 36,  129 => 35,  127 => 34,  120 => 30,  117 => 29,  113 => 22,  104 => 20,  100 => 19,  96 => 17,  93 => 12,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block title %}Mon compte - Do Sport{% endblock %}
...
{% block content %}
    ...
    <!-- affichage du flashMessage si il existe -->
    {# {% for couleurbootstrap, messages in app.flashes(['success', 'danger', 'info', 'warning']) %}
        {% for message in messages %}
        <div class=\"alert alert-{{ couleurbootstrap }}\">{{ message }}</div>
        {% endfor %}
    {% endfor %} #}

    Bienvenue {{ app.user.firstname }} dans votre espace. <br/> C'est ici que vous pourrez gérer toutes vos informations personnelles. <br>

    <hr>

    {% if is_granted('ROLE_ADMIN') %}

    <a href=\"{{ path('admin') }}\">Accéder au backoffice</a> <br/>
    {% endif %}
...
{% endblock %}
", "account/index.html.twig", "C:\\wamp64\\www\\RecupServerDosoprt4\\dosport\\templates\\account\\index.html.twig");
    }
}
