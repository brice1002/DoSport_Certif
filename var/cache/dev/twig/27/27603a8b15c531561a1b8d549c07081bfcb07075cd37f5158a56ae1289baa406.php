...
class __TwigTemplate_ece6b2db6cff63f7eff2a6a34b0a261af04a5480a2ba5c532382885a53b8ff5e extends Template
{
    private $source;
    private $macros = [];
...
{% block content %}
    ...
    <p>
        ...
        <hr>
        Votre commande sera livrée par <strong>{{ order.carrierName }} à l'adresse suivante : </strong><br>
        {{ order.delivery|raw }}
        <hr>
    ...
    {# {{ dump(order) }} #}
{% endblock %}
", "order_success/index.html.twig", "C:\\wamp64\\www\\RecupServerDosoprt4\\dosport\\templates\\order_success\\index.html.twig");
    }
}
