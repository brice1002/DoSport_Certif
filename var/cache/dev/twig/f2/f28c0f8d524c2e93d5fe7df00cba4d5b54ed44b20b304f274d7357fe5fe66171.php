...
class __TwigTemplate_99f0e9cd617dcf46bbcfeb67f81fdf63f97d426e0a96c6c03c9ecafc1df12722 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_title($context, array $blocks = [])
    {
        ...
        echo "Erreur de paiement ! Do Sport";
    ...
    <p>
        ...
        echo "</strong><br><br>
        Votre paiement à échouer pour la commande n°<strong>";
        // line 9
...
{% block title %}Erreur de paiement ! Do Sport{% endblock %}

{% block content %}
    <h2>Erreur de paiement</h2>
    <p>
        Bonjour <strong>{{ order.user.firstname }} {{ order.user.lastname }}</strong><br><br>
        Votre paiement à échouer pour la commande n°<strong>{{ order.reference }}</strong>.<br>
...
", "order_cancel/index.html.twig", "C:\\wamp64\\www\\RecupServerDosoprt4\\dosport\\templates\\order_cancel\\index.html.twig");
    }
}
