...
class __TwigTemplate_91c7a3ebe0dd340b7029456ca0c16e2a73d44969c813cdc92c9f1c432dfbaeeb extends Template
{
    private $source;
    private $macros = [];
...
{% block content %}
    ...
    <div class=\"block-small\">
        <h2>Page introuvable</h2>
        <img src=\"{{ asset('assets/img/DoSport_Logo.png') }}\" alt=\"logo DoSport\">
        <p>Nous sommes navrés, cette page ne semble pas être accessible pour le moment</p>
...
{% endblock %}
", "@Twig/Exception/error.html.twig", "C:\\wamp64\\www\\RecupServerDosoprt4\\dosport\\templates\\bundles\\TwigBundle\\Exception\\error.html.twig");
    }
}
